...
class Util::VirshDomainXmlDiffer
  ...
  def initialize(expected, actual)
    ...
    # add known autogenerated things to the expected so that they are checked
    set_attribute!(expected, '/domain/devices/graphics', 'listen', '0.0.0.0')
    add_element!(expected, '/domain/devices/graphics', 'listen')
    set_attribute!(expected, '/domain/devices/graphics/listen', 'type', 'address')
    set_attribute!(expected, '/domain/devices/graphics/listen', 'address', '0.0.0.0')
  ...
  def add_element!(document, xpath, ele_name)
    REXML::XPath.match(document, xpath).each { |ele| ele.add_element(ele_name) }
  end
